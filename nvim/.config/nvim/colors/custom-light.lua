...
hl("DiagnosticHint", { fg = colors.lightblue700 })
...
hl("Function", { fg = colors.lightblue700, bold = true })
hl("Identifier", { fg = colors.lightblue700, bold = true })
hl("Type", { fg = colors.softthulian600 })
hl("Special", { fg = colors.softthulian600 })
hl("@tag.html", { fg = colors.lightblue700 })
