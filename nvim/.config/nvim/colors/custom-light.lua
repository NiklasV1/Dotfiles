...
hl("MatchParen", { fg = colors.black, bg = colors.gray300 })
...
hl("StatusLine", { fg = colors.black, bg = colors.gray200 })
hl("StatusLineAlt", { fg = colors.white, bg = colors.darkgreen700 })
...
hl("@markup.list.unchecked", { fg = colors.black, bg = colors.alert200 })
