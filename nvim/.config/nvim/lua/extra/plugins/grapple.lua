return {
	...
	keys = {
		...
		{ "<leader>g6", "<cmd>Grapple select index=6<cr>", desc = "[G]rapple [6]" },
		{ "<leader>g7", "<cmd>Grapple select index=7<cr>", desc = "[G]rapple [7]" },
		{ "<leader>g8", "<cmd>Grapple select index=8<cr>", desc = "[G]rapple [8]" },
		{ "<leader>g9", "<cmd>Grapple select index=9<cr>", desc = "[G]rapple [9]" },
		{ "<leader>g0", "<cmd>Grapple select index=10<cr>", desc = "[G]rapple [10]" },
